...
(() => {
  ...
  /* Expose the active language synchronously (before DOMContentLoaded) so
     JS renderers that run at parse time — news cards, etc. — pick the right
     language on first render, not just after a toggle. */
  window.HALOVN_LANG = getLang();
